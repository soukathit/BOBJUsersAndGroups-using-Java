...
public class ChangeUniverseConnectionTest {

    // 
    // This sample is used to change the connection used by a single-source universe published in the 
    // CMS repository
    // 
    ...
    @Test
	public void changeUniverseConnectionTest() throws SDKException {
    	
        // Retrieves the CmsResourceService.class service
        CmsResourceService service = context.getService(CmsResourceService.class);

        // Changes Connection
        service.changeUniverseConnection(UNX_PATH, CNS_NEW);
